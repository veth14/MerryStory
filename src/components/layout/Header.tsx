      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10 2xl:px-16">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link href="/" className="text-gray-600 hover:text-brand-yellow transition-colors font-medium text-sm">Home</Link>
            <Link href="/#packages" className="text-gray-600 hover:text-brand-yellow transition-colors font-medium text-sm">Collections</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col items-center">
            <Link href="/" className="block px-3 py-2 text-gray-800 font-medium hover:text-brand-yellow" onClick={() => setIsMenuOpen(false)}>Home</Link>
            <Link href="/#packages" className="block px-3 py-2 text-gray-800 font-medium hover:text-brand-yellow" onClick={() => setIsMenuOpen(false)}>Collections</Link>
