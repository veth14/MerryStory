      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4 pt-2">
        <div>
          ...
          <h1 className="text-5xl font-black text-[#1d1d1f] tracking-tight">
            Support <span className="text-[#d4a017] italic pr-2">Center</span>
          </h1>
        ...
        <div className="w-full max-w-5xl bg-white border border-gray-100 rounded-[24px] shadow-sm overflow-hidden animate-in fade-in duration-500 flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/5 p-10 bg-[#fafafa] border-b lg:border-b-0 lg:border-r border-gray-100 relative overflow-hidden">
            ...
            <div className="flex items-start gap-5 mb-8">
              <div className="w-14 h-14 bg-[#1d1d1f] text-white rounded-full flex items-center justify-center shrink-0 shadow-lg shadow-black/10">
                <Code size={24} className="text-[#d4a017]" />
              </div>
              <div>
                <h2 className="text-xl font-black text-[#1d1d1f] flex items-center gap-2">
                  Ian Angelo Valmores
                </h2>
                <p className="text-xs font-bold text-[#d4a017] uppercase tracking-widest flex items-center gap-1 mt-1">
            ...
            <div className="space-y-4">
              {/* Phone Link */}
              <a href="tel:09957419175" className="flex items-center gap-4 p-4 rounded-xl border border-gray-200 bg-white hover:shadow-md transition-all group cursor-pointer" onClick={(e) => { e.preventDefault(); showAlert('Direct line copied to clipboard.', 'success'); }}>
              ...
              {/* Email Link */}
              <a href="mailto:vianangelo.14@gmail.com" className="flex items-center gap-4 p-4 rounded-xl border border-gray-200 bg-white hover:shadow-md transition-all group cursor-pointer" onClick={(e) => { e.preventDefault(); showAlert('Email address copied to clipboard.', 'success'); }}>
                <div className="w-10 h-10 rounded-full bg-[#fafafa] border border-gray-100 flex items-center justify-center shrink-0 group-hover:scale-110 group-hover:bg-[#1d1d1f] group-hover:text-white transition-all">
                  <Mail size={16} />
                </div>
                <div className="flex-1">
              ...
              <form onSubmit={handleSendMessage} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="w-full px-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl text-sm font-medium text-[#1d1d1f] focus:ring-2 focus:ring-[#d4a017]/20 focus:border-[#d4a017] transition-all outline-none appearance-none cursor-pointer"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl text-sm font-medium text-[#1d1d1f] focus:ring-2 focus:ring-[#d4a017]/20 focus:border-[#d4a017] transition-all outline-none resize-none"
                  ></textarea>
                </div>
                ...
                <div className="pt-2 flex justify-end">
                  ...
                  >
                    {isSending ? (
                      <><Loader2 size={16} className="animate-spin" /> Sending Ticket...</>
                    ) : success ? (
                      <><CheckCircle2 size={16} className="text-emerald-400" /> Message Sent</>
                    ) : (
